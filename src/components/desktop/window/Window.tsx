...
const Window = ({
  ...
  return (
    <motion.div
      ref={windowRef}
      className={cn(
        "fixed rounded-lg bg-black bg-opacity-30 overflow-hidden pointer-events-auto backdrop-filter backdrop-blur-md border-[0.9px] border-[#ffffff21] shadow-xl"
      )}
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 flex justify-center pointer-events-none">
          <h2 className="text-xs font-medium text-white/70 truncate max-w-[60%]"></h2>
        </div>
        ...
        <div className="flex items-center space-x-1">
          ...
          <div className="flex space-x-1 mr-1">
            ...
            >
              <IconChevronLeft size={14} className="text-[#4C4F69]" />
            </button>
            <button
            ...
            >
              <IconChevronRight size={14} className="text-[#4C4F69]" />
            </button>
            <button
            ...
            >
              <IconChevronUp size={14} className="text-[#4C4F69]" />
            </button>
            <button
            ...
            >
              <IconChevronDown size={14} className="text-[#4C4F69]" />
            </button>
          </div>
          ...
          <div className="flex space-x-1">
            ...
            >
              <IconCornerUpLeft size={14} className="text-[#4C4F69]" />
            </button>
            <button
            ...
            >
              <IconCornerUpRight size={14} className="text-[#4C4F69]" />
            </button>
            <button
            ...
            >
              <IconCornerDownLeft size={14} className="text-[#4C4F69]" />
            </button>
            <button
            ...
            >
              <IconCornerDownRight size={14} className="text-[#4C4F69]" />
            </button>
          </div>
          ...
          >
            {isMaximized ? (
              <IconMinimize size={14} className="text-[#4C4F69]" />
            ) : (
              <IconMaximize size={14} className="text-[#4C4F69]" />
            )}
          </button>
        </div>
      </div>
